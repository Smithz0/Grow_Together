...
export default function SignUpSupabase() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      // User will be redirected automatically on successful signup
    }
    setLoading(false);
  };
        ...
        <Card className="glass border-white/20 shadow-elegant">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="text-center text-sm text-muted-foreground">
              ...
              <Link to="/signin-supabase" className="text-primary hover:text-primary-glow transition-smooth font-medium">
                Sign in
              </Link>
            </div>
          </CardContent>
